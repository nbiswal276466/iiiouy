...
/**
 * Formats Money to crypto with decimals.
 *
 */
final class DecimalCryptoFormatter implements MoneyFormatter
{
    /**
     * @var int
     */
    ...
    public function format(Money $money)
    {
        if (BitcoinCurrencies::CODE !== $money->getCurrency()->getCode()) {
            throw new FormatterException('Crypto Decimals Formatter can only format Crypto currency');
        }
        ...
        if ($this->fractionDigits > $subunit) {
