        ...
        <div v-if="health && !busy">
            ...
            <div class="health">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                      <td>{{ $t('admin.health_checker.ethereum_node') }}</td>
                      <td><span :class="{'badge badge-pill' : true, 'badge-success': health.ethereum, 'badge-secondary': !health.ethereum}">{{ health.ethereum ? $t('admin.online') : $t('admin.offline') }}</span></td>
                    </tr>
                    <tr>
                      <td>{{ $t('admin.health_checker.coinpayments_node') }}</td>
                      <td><span :class="{'badge badge-pill' : true, 'badge-success': health.coinpayments, 'badge-secondary': !health.coinpayments}">{{ health.coinpayments ? $t('admin.online') : $t('admin.offline') }}</span></td>
                    </tr>
                    <tr>
